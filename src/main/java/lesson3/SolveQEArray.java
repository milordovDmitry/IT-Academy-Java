...
/**
 * Решение квадратного уравнения. Метод SolveQEArray принимает значения коэффициентов квадратного уравнения и возращает
 * результаты в виде массива. main метод в зависимости от количества элементов в массиве выводит в консоль корни
 * уравнения.
